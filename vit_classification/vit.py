...
class ViT(nn.Module):
    ...
    def patchify(self, images):
        ...
        images = images.view(images.shape[0], -1, self.patch_dim * self.patch_dim * 3)
        return images
    ...
    def forward(self, images):
        ...
        output = torch.cat([cls_token, patches_embedded], dim = 1) # This seems useless given next line
